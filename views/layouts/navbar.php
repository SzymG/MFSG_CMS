...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        if($session['yii_user_root'] == 1) {
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <?= Html::a(Yii::t('app', 'a_amenu_config'), ['/configadmin/index'], ['class' => 'nav-link']) ?>
            </li>

            <li class="nav-item d-none d-sm-inline-block">
                <?= Html::a(Yii::t('app', 'a_amenu_page'), ['/pageadmin/index'], ['class' => 'nav-link']) ?>
            </li>

            <li class="nav-item d-none d-sm-inline-block">
                <?= Html::a(Yii::t('app', 'a_amenu_events'), ['/eventadmin/index'], ['class' => 'nav-link']) ?>
            </li>

            <li class="nav-item d-none d-sm-inline-block">
                <?= Html::a(Yii::t('app', 'a_amenu_news'), ['/newsadmin/index'], ['class' => 'nav-link']) ?>
            </li>

            <li class="nav-item dropdown d-none d-sm-inline-block">
                <?= Html::a(Yii::t('app', 'a_amenu_users'), '#', ['data-toggle' => 'dropdown',  'aria-haspopup' => 'true', 'aria-expanded' => 'false','class' => 'nav-link  dropdown-toggle']) ?>
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                    <li class="nav-item"><?= Html::a(Yii::t('app', 'a_amenu_users'), ['/useradmin/index'], ['class' => 'nav-link']) ?></li>
                    <li class="nav-item"><?= Html::a(Yii::t('app', 'a_amenu_logs'), ['/logadmin/index'], ['class' => 'nav-link']) ?></li>
                </ul>
            </li>

            <li class="nav-item d-none d-sm-inline-block">
                <?= Html::a(Yii::t('app', 'a_amenu_left_menu'), ['/leftmenuadmin/index'], ['class' => 'nav-link']) ?>
            </li>
